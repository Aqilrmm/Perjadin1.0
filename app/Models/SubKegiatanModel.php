...
class SubKegiatanModel extends BaseModel
{
    ...
    protected $allowedFields = [
        'uuid', 'kegiatan_id', 'kode_sub_kegiatan', 'nama_sub_kegiatan',
        'anggaran_sub_kegiatan', 'deskripsi', 'status', 'catatan_kepala_dinas',
        'approved_by', 'approved_at', 'submitted_at', 'created_by'
    ];
    ...
    /**
     * Get approved sub kegiatan for dropdown
     */
    ...
    /**
     * Get sisa anggaran sub kegiatan
     */
    ...
    /**
     * Validate anggaran tidak melebihi kegiatan
     */
    public function validateAnggaran($kegiatanId, $anggaranSubKegiatan, $subKegiatanId = null)
    {
        ...
        // If updating, add back current sub kegiatan anggaran
        if ($subKegiatanId) {
    ...
    /**
     * Get sub kegiatan with budget info
     */

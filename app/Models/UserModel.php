...
class UserModel extends BaseModel
{
    ...
    protected $allowedFields = [
        'uuid', 'nip_nik', 'gelar_depan', 'nama', 'gelar_belakang',
        'jenis_pegawai', 'email', 'password', 'jabatan', 'bidang_id',
        'role', 'foto', 'is_active', 'is_blocked', 'blocked_reason',
        'blocked_at', 'blocked_by', 'login_attempts', 'last_login'
    ];
